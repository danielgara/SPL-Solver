...
def test_build_feature_model_1():
    with open('./tests/resources/test_1.xml') as tree_test_1:
        feature_model = build_feature_model(tree_test_1.read())
    ...
    assert feature_model == feature_model_dict


def test_build_feature_model_2():
    with open('./tests/resources/test_2.xml') as tree_test_2:
        feature_model = build_feature_model(tree_test_2.read())
    ...
    feature_model_dict = {
        ...
        "features": [
            ...
            {"label": "Web management", "type": "abstract", "id": "263"},
            {"label": "User", "type": "abstract", "id": "270"},
            {"label": "ClothingStores", "type": "root", "id": "1"},
        ],
        "relations": [
            {"type": "optional", "source": "2", "target": "1"},
            {"type": "optional", "source": "3", "target": "1"},
